...
// Use the local, modified copy of go-libp2p (pkg/go-libp2p) instead of the
// published v0.49.0. The fork adds tcp.WithListenControl so P2P TCP listen
...
replace github.com/libp2p/go-libp2p v0.49.0 => ./pkg/go-libp2p
